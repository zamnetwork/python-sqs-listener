...
class SqsListener(object):
    ...
    def __init__(self, queue, **kwargs):
        ...
        # must come last
        boto3_session = kwargs.get('boto3_session', None)
        if boto3_session:
    ...
    def _initialize_client(self):
        ...
        sqs = self._session.client(
            'sqs', region_name=self._region_name, endpoint_url=self._endpoint_name, use_ssl=ssl)
    ...
    def _start_listening(self):
        ...
        while True:
            ...
            if 'Messages' in messages:
                ...
                sqs_logger.info("{} messages received".format(
                ...
                for m in messages['Messages']:
                    ...
                    try:
                        if self._force_delete:
                            ...
                            self.handle_message(
                                params_dict, message_attribs, attribs)
                        else:
                            self.handle_message(
                                params_dict, message_attribs, attribs)
                            self._client.delete_message(
